...
public class Login extends JFrame implements ActionListener{
	...
	panel.setLayout(null);
        ...
        JLabel nam=new JLabel("Login Page");
        nam.setBounds(360,20,220,65);
        nam.setForeground(new Color(0,0,0));
        nam.setFont(new Font("Serif",Font.BOLD,38));
        panel.add(nam);
	...
	JLabel l3 = new JLabel("");
        ...
        Image i5 = i4.getImage().getScaledInstance(38, 32,Image.SCALE_DEFAULT);
	...
	panel.add(l23);
        ...
        ImageIcon back;
        back = new ImageIcon(ClassLoader.getSystemResource("nosqplpj/icons/bg.jpg"));
